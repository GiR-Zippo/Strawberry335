...
/// Exit the realm
bool ChatHandler::HandleServerExitCommand(const char* )
{
...
bool ChatHandler::HandleServerToggleQueryLogging(const char* )
{
...
void CliRunnable::run()
{
    ...
    while (!Logon::IsStopped())
    {
        ...
        if (command_str != NULL)
        {
            ...
            fflush(stdout);
            sLogon->QueueCliCommand(new CliCommandHolder(NULL, command.c_str(), &utf8print, &commandFinished));
            #if PLATFORM != PLATFORM_WINDOWS
