...
struct GroupQueueInfo                                       // stores information about the group in queue (also used when joined as solo!)
{
    ...
    uint32  QueuePosition;                                  // .bgquery
    BattlegroundBracketId BracketId;                        // .bgquery
};
...
enum GenericSpells
{
    SPELL_BG_DESERTER_DEBUFF = 26013
};
...
class BattlegroundQueue
{
    public:
        ...
        int32 GetPlayerPosition(uint64 guid);
    ...
    private:
        ...
        int32 m_statusA[MAX_BATTLEGROUND_BRACKETS];
        int32 m_statusH[MAX_BATTLEGROUND_BRACKETS];
        BattlegroundBracketId currentBracket;
};
