...
void BattlegroundDS::ResetBGSubclass()
{
}
...
bool BattlegroundDS::SetupBattleground()
{
    ...
    if (!AddObject(BG_DS_OBJECT_DOOR_1, BG_DS_OBJECT_TYPE_DOOR_1, 1350.95f, 817.2f, 20.8096f, 3.15f, 0, 0, 0.99627f, 0.0862864f, RESPAWN_IMMEDIATELY)
        ...
        // knockback creatures
        || !AddCreature(BG_DS_NPC_TYPE_WATER_SPOUT, BG_DS_NPC_WATERFALL_KNOCKBACK, 0, 1291.791992f, 790.979736f, 7.114801f, 3.054326f, RESPAWN_IMMEDIATELY)
