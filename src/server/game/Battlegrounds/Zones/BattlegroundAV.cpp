...
BattlegroundAV::BattlegroundAV() : Battleground()
{
...
void BattlegroundAV::HandleKillUnit(Creature* unit, Player* killer)
{
    ...
    */
    if (entry == BG_AV_CreatureInfo[AV_NPC_A_BOSS][0])
    {
        ...
        RewardReputationToTeam(BG_AV_FACTION_HORDE, BG_AV_REP_BOSS, HORDE, BG_AV_FACTION_ALLIANCE);
    ...
    else if (entry == BG_AV_CreatureInfo[AV_NPC_H_BOSS][0])
    {
        ...
        RewardReputationToTeam(BG_AV_FACTION_ALLIANCE, BG_AV_REP_BOSS, ALLIANCE, BG_AV_FACTION_HORDE);
    ...
    else if (entry == BG_AV_CreatureInfo[AV_NPC_A_CAPTAIN][0])
    {
        ...
        RewardReputationToTeam(BG_AV_FACTION_HORDE, BG_AV_REP_CAPTAIN, HORDE, BG_AV_FACTION_ALLIANCE);
    ...
    else if (entry == BG_AV_CreatureInfo[AV_NPC_H_CAPTAIN][0])
    {
        ...
        RewardReputationToTeam(BG_AV_FACTION_ALLIANCE, BG_AV_REP_CAPTAIN, ALLIANCE, BG_AV_FACTION_HORDE);
...
void BattlegroundAV::EndBattleground(uint32 winner)
{
    ...
    for (int i=0; i <= 1; i++) //0=ally 1=horde
    {
        ...
        if (rep[i] != 0)
            RewardReputationToTeam((i == 0) ? BG_AV_FACTION_ALLIANCE : BG_AV_FACTION_HORDE, rep[i],
                                    (i == 0) ? ALLIANCE : HORDE, (i == 0) ? BG_AV_FACTION_HORDE : BG_AV_FACTION_ALLIANCE);
        if (kills[i] != 0)
...
void BattlegroundAV::EventPlayerDestroyedPoint(BG_AV_Nodes node)
{
    ...
    if (IsTower(node))
    {
        ...
        RewardReputationToTeam((owner == ALLIANCE) ? BG_AV_FACTION_ALLIANCE : BG_AV_FACTION_HORDE, BG_AV_REP_TOWER,
                               owner, (owner == ALLIANCE) ? BG_AV_FACTION_HORDE : BG_AV_FACTION_ALLIANCE);
