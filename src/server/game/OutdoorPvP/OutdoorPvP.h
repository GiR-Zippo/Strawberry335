...
public:
    ...
    virtual void HandlePlayerLeave(Player* player, uint64 guid = 0);
...
public:
    ...
    virtual bool HandleOPvPGroupDisband(Group* group);
    virtual bool HandleOPvPGroupRemoveMember(Player* player, const RemoveMethod &method = GROUP_REMOVEMETHOD_DEFAULT);
