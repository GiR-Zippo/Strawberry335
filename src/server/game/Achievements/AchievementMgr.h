...
class AchievementMgr
{
    public:
        ...
        void ResetAchievementCriteriaAddition(AchievementCriteriaTypes type, uint32 miscvalue1 = 0, uint32 miscvalue2 = 0, bool evenIfCriteriaComplete = false);
        ...
        void CompletedAchievementAddition(AchievementEntry const* entry);
    ...
    private:
        ...
        void SetCriteriaProgressAddition(AchievementCriteriaEntry const* entry, uint32 changeValue, ProgressType ptype = PROGRESS_SET);
