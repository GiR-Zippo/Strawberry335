...
class CreatureAI : public UnitAI
{
    ...
    public:
        ...
        void BossWhisper(uint8 id, uint64 WhisperGuid = 0);
        ...
        virtual void JustSummoned(GameObject* /*summon*/) {}

        virtual void SummonedGameObjectRemoved(GameObject* /*summon*/) {}
        virtual void SummonedGameObjectDeleted(GameObject* /*summon*/) {}
        ...
        void DoZoneInCombat(Creature* creature = NULL, float maxRangeToNearestTarget = 50.0f, bool includePets = true);
