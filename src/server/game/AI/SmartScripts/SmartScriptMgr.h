...
enum SMART_EVENT
{
    ...
    SMART_EVENT_NEAR_PLAYERS             = 74,      // min, radius, first timer, check timer
    SMART_EVENT_NEAR_PLAYERS_NEGATION    = 75,      // min, radius, first timer, check timer
    SMART_EVENT_COUNTER_SET              = 76,      // id, value, cooldownMin, cooldownMax
...
enum SMART_ACTION
{
    ...
    SMART_ACTION_SUMMON_CREATURE                    = 12,     // CreatureID, summonType, duration in ms, storageID, attackInvoker, count
    ...
    // Custom actions
    SMART_ACTION_SET_HP                             = 111,    // flat, percentage
    SMART_ACTION_CONE_SUMMON                        = 112,    // id, duration, dist, dist, length, width
    SMART_ACTION_RESET_THREATLIST                   = 113,
    SMART_ACTION_PLAYER_TALK                        = 114,    // creature_text.id
    SMART_ACTION_PLAYER_MARK                        = 115,
    SMART_ACTION_PLAYER_SEND_BOSSWHISPER            = 116,
    SMART_ACTION_CALL_CHALLENGE_STOP                = 117,    // Requires instance script to have that function
    SMART_ACTION_SET_COUNTER                        = 118,    // id, incr, decr, reset (0/1)
    SMART_ACTION_JOIN_TARGETS_GROUP                 = 119,
    SMART_ACTION_GAMEOBJECT_REMOVE                  = 120,
    SMART_ACTION_CUSTOM_CAST                        = 121,    // spell, flag, bp1, bp2, bp3
    SMART_ACTION_VORTEX_SUMMON                      = 122,
    SMART_ACTION_PLAYER_JUMP_TO_POS                 = 123, 

    SMART_ACTION_END                                = 124,
};
...
enum SMARTAI_TARGETS
{
    ...
    SMART_TARGET_NEAR_RANDOM_POSITION           = 27,   // radius, noPos, use xyz
    SMART_TARGET_PLAYER_WITH_AURA               = 28,   // spellID, negatation?, distance
    SMART_TARGET_FARTHEST                       = 29,   // todo params
    SMART_TARGET_PLAYER_WITHOUT_MULTI_AURA      = 30,   // spellID1, spellID2, spellID3, distance in target_x, counter in target_o
