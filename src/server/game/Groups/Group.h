...
enum RaidTargetIcon
{
    RAID_TARGET_ICON_NO_ICON,
    RAID_TARGET_ICON_YELLOW_STAR,
    RAID_TARGET_ICON_ORANGE_CIRCLE,
    RAID_TARGET_ICON_PURPLE_DIAMOND,
    RAID_TARGET_ICON_GREEN_TRIANGLE,
    RAID_TARGET_ICON_WHITE_MOON,
    RAID_TARGET_ICON_BLUE_SQUARE,
    RAID_TARGET_ICON_RED_CROSS,
    RAID_TARGET_ICON_WHITE_SKULL,
    RAID_TARGET_ICON_MAX,
};
...
class Group
{
    ...
    public:
        ...
        void SetOutdoorPvPGroup(OutdoorPvP* oPvP);
        ...
        bool is_mixed_group() const { return m_mixed_group; }
