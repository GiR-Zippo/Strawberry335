...
/** Native DBC Data additions and overrides
 * -Specialize function template to use it
 * -It will be called after dbc loaded
 */

template<>
// DungeonEncounter.dbc - sDungeonEncounterStore
void DBCStorage<DungeonEncounterEntry>::loadAdditionsAndOverrides()
{
    DungeonEncounterEntry* pDungeonEncounterEntries[4];
    memset(pDungeonEncounterEntries, 0, sizeof(pDungeonEncounterEntries));

    // Hallow's End missing last encounter entry "Headless Horseman" of dungeon entry 285
    pDungeonEncounterEntries[0] = new DungeonEncounterEntry();
    pDungeonEncounterEntries[0]->id = 895;
    pDungeonEncounterEntries[0]->mapId = 189; // Scarlet Monastery
    pDungeonEncounterEntries[0]->difficulty = 0;
    pDungeonEncounterEntries[0]->encounterIndex = 0;
    pDungeonEncounterEntries[0]->encounterName[0] = "Der kopflose Reiter";

    // Midsummer Fire Festival missing last encounter entry "Ahune" of dungeon entry 286
    pDungeonEncounterEntries[1] = new DungeonEncounterEntry();
    pDungeonEncounterEntries[1]->id = 896;
    pDungeonEncounterEntries[1]->mapId = 547; // Slave Pens
    pDungeonEncounterEntries[1]->difficulty = 0;
    pDungeonEncounterEntries[1]->encounterIndex = 0;
    pDungeonEncounterEntries[1]->encounterName[0] = "Ahune";

    // Brewfest missing last encounter entry "Coren Direbrew" of dungeon entry 287
    pDungeonEncounterEntries[2] = new DungeonEncounterEntry();
    pDungeonEncounterEntries[2]->id = 897;
    pDungeonEncounterEntries[2]->mapId = 230; // Blackrock Depths
    pDungeonEncounterEntries[2]->difficulty = 0;
    pDungeonEncounterEntries[2]->encounterIndex = 0;
    pDungeonEncounterEntries[2]->encounterName[0] = "Coren Düsterbräu";

    // Love is in the Air missing last encounter entry "Apothecary Hummel" of dungeon entry 288
    pDungeonEncounterEntries[3] = new DungeonEncounterEntry();
    pDungeonEncounterEntries[3]->id = 898;
    pDungeonEncounterEntries[3]->mapId = 33; // Shadowfang Keep
    pDungeonEncounterEntries[3]->difficulty = 0;
    pDungeonEncounterEntries[3]->encounterIndex = 0;
    pDungeonEncounterEntries[3]->encounterName[0] = "Apotheker Hummel";

    for (uint8 i = 0; i < (sizeof(pDungeonEncounterEntries) / sizeof(DungeonEncounterEntry*)); ++i)
    {
        if (pDungeonEncounterEntries[i])
        {
            indexTable.asT[pDungeonEncounterEntries[i]->id] = pDungeonEncounterEntries[i];
            ++nCount;

            sLog->outStaticDebug("DBCStorage<DungeonEncounterEntry>::loadAdditionsAndOverrides: ID %u added to nCount %u",
                                 pDungeonEncounterEntries[i]->id, nCount);
        }
    }
}
