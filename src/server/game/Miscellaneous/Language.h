...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_UNIT_OUTFIGHT                  = 843,
    LANG_UNIT_INFIGHTLIST               = 844,

    // Room for in-game strings 845-999 not used
    ...
    LANG_COMMAND_TARGET_PROFESSIONS     = 1151,
    LANG_COMMAND_PROFESSION_ALCHEMY     = 1152,
    LANG_COMMAND_PROFESSION_BLACKSMITH  = 1153,
    LANG_COMMAND_PROFESSION_ENCHANTING  = 1154,
    LANG_COMMAND_PROFESSION_ENGINEERING = 1155,
    LANG_COMMAND_PROFESSION_HERBALISM   = 1156,
    LANG_COMMAND_PROFESSION_INSCRIPTION = 1157,
    LANG_COMMAND_PROFESSION_JEWELRY     = 1158,
    LANG_COMMAND_PROFESSION_LEATHER     = 1159,
    LANG_COMMAND_PROFESSION_MINING      = 1160,
    LANG_COMMAND_PROFESSION_SKINNING    = 1161,
    LANG_COMMAND_PROFESSION_TAILORING   = 1162,
    LANG_COMMAND_PROFESSION_COUNT       = 1163,
    LANG_COMMAND_REMOVE_PROFESSION      = 1164,
    ...
    LANG_BG_SA_GY_EAST_ENGINEER_VISIBLE     = 10074, // Sparklight´s vehicle shop is open for business!
    LANG_BG_SA_GY_WEST_ENGINEER_VISIBLE     = 10075, // Rigspark´s vehicle shop is open for business!
    LANG_BG_SA_GY_CAPTURE_FAIL              = 10076, // You cannot capture this graveyard yet.
    ...
    LANG_ARENA_TEAM_CREATE              = 12997,
    LANG_ARENA_TEAM_ERROR_NAME_EXISTS   = 12998,
    LANG_ARENA_TEAM_ERROR_SIZE          = 12999,
    LANG_ARENA_TEAM_VIEW                = 13000,
    LANG_ARENA_TEAM_MEMBER              = 13001,
    LANG_ARENA_TEAM_CAPTAIN             = 13002,
    LANG_ARENA_TEAM_NOT_FOUND           = 13003,
    LANG_ARENA_TEAM_DELETED             = 13004,
    LANG_ARENA_TEAM_RENAMED             = 13005,
    LANG_GUILD_RENAMED                  = 13006,
    LANG_LOOKUP_PLAYER_CHARACTER_ONLINE = 13007,

    LANG_MISSING_ACHIEVEMENT_ICC        = 13009,
    LANG_COMMAND_QUEST_REPORT_INSERT    = 13010,

    // Wintergrasp
    LANG_WG_SPIRIT_GUIDE_FORTRESS_GY = 20070, // Guide me to the Fortress Graveyard.
    LANG_WG_SPIRIT_GUIDE_SUNKENRING_GY = 20071, // Guide me to the Sunken Ring Graveyard.
    LANG_WG_SPIRIT_GUIDE_BROKENTEMPLE_GY = 20072, // Guide me to the Broken Temple Graveyard.
    LANG_WG_SPIRIT_GUIDE_EASTPARK_GY = 20073, // Guide me to the Eastspark Graveyard.
    LANG_WG_SPIRIT_GUIDE_WESTPARK_GY = 20074, // Guide me to the Westspark Graveyard.
    LANG_WG_SPIRIT_GUIDE_HORDELANDING_GY = 20075, // Guide me back to the Horde landing camp.
    LANG_WG_SPIRIT_GUIDE_ALLIANCELANDING_GY = 20076, // Guide me back to the Alliance landing camp.
    LANG_WG_QUEUE_JOIN = 20077, // Queue for the battle of Wintergrasp.
    LANG_WG_CANNOT_TELE_DURING_BATTLE = 20078, // During a battle you can not teleport

    LANG_WG_WORKSHOP_ATTACK_ALLIANCE = 20080, // The %s has been attacked by the Alliance!
    LANG_WG_WORKSHOP_ATTACK_HORDE = 20081, // The %s has been attacked by the Horde!
    LANG_WG_WORKSHOP_TAKEN_ALLIANCE = 20082, // The %s has been taken by the Alliance!
    LANG_WG_WORKSHOP_TAKEN_HORDE = 20083, // The %s has been taken by the Horde!
    LANG_WG_TOWER_DAMAGED = 20084, // The %s is under attack!
    LANG_WG_TOWER_DESTROYED = 20085, // The %s has been destroyed!
    LANG_WG_START_TIME_BATTLE = 20086, // The battle for wintergrasp begins in %s minutes!
    LANG_WG_PORTAL_SPAWN = 20087, // Portals will be spawned when the battle begins!
    LANG_WG_START_BATTLE = 20088, // The battle for wintergrasp begins!
    LANG_WG_END_WON_BATTLE = 20089, // The %s has occupied the keep!
    LANG_WG_END_LOOSE_BATTLE = 20090, // The %s has defended the keep!

    LANG_WG_SUNKEN_RING_WS = 20091, // Sunken Ring siege workshop
    LANG_WG_BROKEN_TEMPLE_WS = 20092, // Broken Temple siege workshop
    LANG_WG_EASTPARK_WS = 20093, // Eastpark siege workshop
    LANG_WG_WESTPARK_WS = 20094, // Westpark siege workshop
    LANG_WG_SHADOWSIGHT_TOWER = 20095, // Shadowsight tower
    LANG_WG_WINTERS_EDGE_TOWER = 20096, // Winter's Edge tower
    LANG_WG_FLAMEWATCH_TOWER = 20097, // Flamewatch tower
    LANG_WG_NORTH_WEST_KEEP_TOWER = 20098, // north-west keep tower
    LANG_WG_SOUTH_WEST_KEEP_TOWER = 20099, // south-west keep tower
    LANG_WG_SOUTH_EAST_KEEP_TOWER = 20100, // south-east keep tower
    LANG_WG_NORTH_EAST_KEEP_TOWER = 20101, // north-east keep tower
    LANG_WG_KEEP_UNDER_ATTACK = 20102, // The keep is under attack!

    LANG_WG_RANK_CORPORAL_REACHED = 20103, // You have reached Rank 1: Corporal
    LANG_WG_RANK_LIEUTNANT_REACHED = 20104, // You have reached Rank 2: First Lieutnant
    LANG_WG_START_TIME_30 = 20105, // 30
    LANG_WG_START_TIME_15 = 20106, // 15
    LANG_WG_CANNOT_JOIN_BATTLE = 20107, // The battle of wintergrasp is full
    LANG_WG_FORCE_CHANGE = 20108, // The owner of wintergrasp will be changed. The third consecutive victory was achieved.
    LANG_WG_WILL_BE_TELEPORTED = 20109, // You are not allowed to be here. You have %u seconds to relocate.
