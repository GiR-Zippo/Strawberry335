 ...
 *
 * IMPORTANT <01.04.2015 - TehKevin>: Handling moved to Logon
 */
...
//
//        sWorld->SendGMText(LANG_COMMAND_TICKETNEW, GetPlayer()->GetPlayerLink().c_str(), ticket->GetId());
//
...
//
//        sWorld->SendGMText(LANG_COMMAND_TICKETUPDATED, GetPlayer()->GetPlayerLink().c_str(), ticket->GetId());
//
...
//        SendPacket(&data);
//
//        sWorld->SendGMText(LANG_COMMAND_TICKETPLAYERABANDON, GetPlayer()->GetPlayerLink().c_str(), ticket->GetId());
//
