...
class ObjectAccessor
{
    ...
    public:
        ...
        static Unit* GetUnit(WorldObject const&, uint64 guid, bool alive = false);
        static Creature* GetCreature(WorldObject const& u, uint64 guid, bool alive = false);
        static Pet* GetPet(WorldObject const&, uint64 guid, bool alive = false);
        static Player* GetPlayer(WorldObject const&, uint64 guid, bool alive = false);
        static Creature* GetCreatureOrPetOrVehicle(WorldObject const&, uint64, bool alive = false);
