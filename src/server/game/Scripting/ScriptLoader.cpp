...
void AddSC_trial_of_the_champion();      //Trial of the Champion
...
void AddSC_halls_of_reflection();       // Halls of Reflection
void AddSC_icecrowncitadel();           // Icecrown Citadel
...
void AddSC_the_slave_pens();                 //CR The Slave Pens
...
void AddCommandScripts()
{
    ...
    AddSC_battlefield_commandscript();
    ...
    AddSC_restore_commandscript();
    AddSC_server_commandscript();
    AddSC_tele_commandscript();
    AddSC_titles_commandscript();
    AddSC_trans_commandscript();
    AddSC_transmog_commandscript();
    AddSC_unit_commandscript();
...
void AddOutlandScripts()
{
    ...
    AddSC_the_slave_pens();                 //CR Slave Pens
...
void AddNorthrendScripts()
{
    ...
    AddSC_trial_of_the_champion();      //Trial of the Champion
    ...
    AddSC_boss_ick();
    AddSC_boss_tyrannus();
    AddSC_halls_of_reflection();        // Halls of Reflection
    AddSC_icecrowncitadel();            // Icecrown Citadel
...
{
    #ifdef SCRIPTS
    AddSC_Headless_Horseman_Rotten_Hollow();
    #endif
}
