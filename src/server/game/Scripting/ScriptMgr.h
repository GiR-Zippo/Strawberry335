...
class TransportScript : public ScriptObject, public UpdatableScript<Transport>
{
    ...
    public:
        ...
        virtual void OnRelocate(Transport* /*transport*/, uint32 /*waypointId*/, uint32 /*mapId*/, float /*x*/, float /*y*/, float /*z*/, uint32 /*readId*/) { }
};
...
class PlayerScript : public ScriptObject
{
    ...
    public:
        ...
        virtual void OnEquipChanged(Player* /*player*/) { }

        virtual void OnPlayerLootItem(Player* /*player*/ , uint32& /*item_entry*/, ItemPosCountVec& /*dest*/) { }
};
...
class ScriptMgr
{
    ...
    public: /* TransportScript */
        ...
        void OnRelocate(Transport* transport, uint32 waypointId, uint32 mapId, float x, float y, float z, uint32 readId = 0);
    ...
    public: /* PlayerScript */
        ...
        void OnPlayerEquipChanged(Player* player);
        void OnPlayerLootItem(Player* player, uint32& item_entry, ItemPosCountVec& dest);
