...
class Item : public Object
{
    public:
        ...
        static void DeleteFromInventoryDB(SQLTransaction& trans, uint32 itemGuid, uint32 playerGuid);
        void DeleteFromInventoryDB(SQLTransaction& trans, uint32 playerGuid);
        void SaveRefundDataToDB();
        void DeleteRefundDataFromDB(SQLTransaction* trans);
        void SaveItemLootToDB(SQLTransaction* givenTrans = NULL);
        ...
        bool HasRemovedBonus() const { return removedBonus; }
        void SetRemovedBonus(bool state) { removedBonus = state; }
        uint32 GetPermittedItemInArena() const;
