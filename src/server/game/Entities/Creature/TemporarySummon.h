...
class Minion : public TempSummon
{
    public:
        ...
        virtual void InitStats(uint32 duration) override;
        void RemoveFromWorld();
        ...
        bool IsPetGhoul() const {
            return isPet() && m_owner->getClass() == CLASS_DEATH_KNIGHT; // Ghoul may be guardian or pet
        }

        bool IsWarlockPet() const {
            return isPet() && m_owner->getClass() == CLASS_WARLOCK;
        }
