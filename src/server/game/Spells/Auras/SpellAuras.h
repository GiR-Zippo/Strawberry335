...
class Aura
{
    ...
    public:
        ...
        int32 GetModDuration() const { return m_modDuration; }
        void SetModDuration(int32 duration) { m_modDuration = duration; }
    ...
    protected:
        ...
        int32 m_modDuration;                               // Aura mod duration
    ...
    public:
        void InitSnapShot(Unit *caster, Unit *victim);
        void UpdateSnapShot(Unit *caster, Unit *victim);
        float GetSnapShotValue(SnapShotValue ssval, Unit *victim) { return m_SSStores[victim->GetGUID()].val[ssval]; }
    ...
    private:
        ...
        typedef std::map<uint64, SSStore> SSStoreMap;
        SSStoreMap m_SSStores;
};
