...
class AuraEffect
{
    ...
    public:
        ...
        void CalculatePeriodic(Unit* caster, bool create = false, bool load = false, bool refresh = false);
    ...
    public:
        ...
        // cooldown
        void HandleAuraModCooldown(AuraApplication const* aurApp, uint8 mode, bool apply) const;
