...
class Spell
{
    ...
    public:
        ...
        int32 CalculateDamage(uint8 effect, Unit const* target) const { return m_caster->CalculateSpellDamage(target, m_spellInfo, effect, &m_spellValue->EffectBasePoints[effect]); }
    ...
    protected:
        ...
        int32 m_cleanDamage;      // CleanDamage in effects count here
