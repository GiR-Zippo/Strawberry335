...
enum WorldBoolConfigs
{
    ...
    CONFIG_ALLOW_TWO_SIDE_BATTLEGROUNDS,
    ...
    CONFIG_UNIQUE_GM,
    CONFIG_DUNGEON_FINDER_COOLDOWN,
    CONFIG_DUNGEON_FINDER_DESERTER,
    CONFIG_RAID_FINDER_ENABLE,
    CONFIG_CUSTOM_ICC_BUFF_PLAYERCHOOSE,
    CONFIG_CUSTOM_GM_QUALITY_MANAGER,
...
enum WorldIntConfigs
{
    ...
    CONFIG_ARENA_SEASON_TRANSMOG_ID,
    ...
    CONFIG_FACTION_TRANSFER_FACTIONS_ENABLED,
    CONFIG_DUNGEON_FINDER_MAX_JOIN_SIZE,
    CONFIG_DUNGEON_FINDER_MAX_JOIN_TIMES,
    ...
    CONFIG_TELE_DELAY,
    CONFIG_CUSTOM_ICC_BUFF_ALLIANCE,
    CONFIG_CUSTOM_ICC_BUFF_HORDE,
    CONFIG_CUSTOM_ICC_BUFF_LK_ALLIANCE,
    CONFIG_CUSTOM_ICC_BUFF_LK_HORDE,
...
class World
{
    public:
        ...
        bool isWorldState(uint32 index) const;
        ...
        uint32 GetLastDiminishingReturnReset() { return m_lastDiminishingReturnReset; }
        CustomArenaResetTimer* GetCustomArenaResetTimer() { return m_customArenaResetTimer; }
    ...
    private:
        ...
        uint32 m_lastDiminishingReturnReset;
