...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "surveys",                      SEC_ADMINISTRATOR, true,  &HandleReloadSurveySystem,                      "", NULL },
    ...
    {
        sLog->outString("Re-Loading `npc_text` and `locales_npc_text` Table!");
        sObjectMgr->LoadGossipText();
        sObjectMgr->LoadNpcTextLocales();
        handler->SendGlobalGMSysMessage("DB table `npc_text` and `locales_npc_text` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadSurveySystem(ChatHandler* handler, const char* args)
    {
        HandleReloadLocalesNpcTextCommand(handler, args);

        sLog->outString("Re-Loading Survey system...");
        sSurvey.reload();
        handler->SendGlobalGMSysMessage("Re-Loaded Survey System.");
        return true;
    }
