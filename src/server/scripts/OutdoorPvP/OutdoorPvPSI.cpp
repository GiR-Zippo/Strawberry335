...
OutdoorPvPSI::OutdoorPvPSI() : OutdoorPvP(sMapMgr->FindBaseNonInstanceMap(1))
{
...
{
    // Fix for Aura only player below or equal level 70
    if (player->GetTeam() == m_LastController && player->getLevel() <= 70)
