        ...
        struct boss_archaedasAI : public ScriptedAI
        {
            ...
            void UpdateAI(const uint32 uiDiff)
            {
                ...
                if (!bGuardiansAwake && !HealthAbovePct(66))
                {
                    ...
                    ActivateMinion(instance->GetData64(10), true); // EarthenGuardian6
                ...
                if (!bVaultWalkersAwake && !HealthAbovePct(33))
                {
                    ...
                    ActivateMinion(instance->GetData64(3), false);    // VaultWalker3
            ...
            void UpdateAI(const uint32 uiDiff)
            {
                ...
                } else if (bWakingUp && iAwakenTimer <= 0)
                {
                    ...
                    if (Unit *target=me->SelectNearestPlayer(200.0f))
                    {
                        ...
                        me->GetMotionMaster()->MovePoint(0,pos); // minions should attack playerteam
                    }
                    return;
                }
