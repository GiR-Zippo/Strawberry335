    ...
    struct instance_karazhan_InstanceMapScript : public InstanceScript
    {
        ...
        void OnCreatureCreate(Creature* creature)
        {
            switch (creature->GetEntry())
            {
                ...
                case 16151:   m_uiMidnightGUID = creature->GetGUID();            break;
                case 15550:   m_uiAttumenGUID = creature->GetGUID();             break;
                case 16152:   m_uiAttumenMountedGUID = creature->GetGUID();      break;
            }
        }
        ...
        void SetData(uint32 type, uint32 uiData)
        {
         ...
         void SetData64(uint32 identifier, uint64 data)
         {
             switch (identifier)
             {
                 case DATA_IMAGE_OF_MEDIVH: ImageGUID        = data; break;
             }
         }
        ...
        uint64 GetData64(uint32 uiData)
        {
            switch (uiData)
            {
                ...
                case DATA_MIDNIGHT:                 return m_uiMidnightGUID;
                case DATA_ATTUMEN:                  return m_uiAttumenGUID;
                case DATA_ATTUMEN_MOUNTED:          return m_uiAttumenMountedGUID;
