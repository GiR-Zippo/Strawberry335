...
#define MEK_1_1                 "Bürger und Freunde von Gnomeregan!"
#define MEK_1_2                 "Today is the day we take back our glorious city from the vile traitor Thermaplugg!"
#define MEK_1_3                 "Gather around me as we prepare to reclaim our homeland!"
#define SOUND_MEK_1             17535 // 17150
#define MEK_2_1                 "No more shall our people live as refugees, as outcasts, as wretched, irradiated slaves chained to the yoke of a madman's war machine!"
#define SOUND_MEK_2             17536 // 12200
#define MEK_3_1                 "The end of Thermaplugg's reign draws near!"
#define MEK_3_2                 "Gather now at the staging area!"
#define SOUND_MEK_3             17537 // 7050
#define MEK_4_1                 "Our tactics, our science, our bravery and determination shall prevail."
#define MEK_4_2                 "The assault begins in but a moment!"
#define SOUND_MEK_4             17538 // 10180
#define MEK_5_1                 "Operation: Gnomeregan begins NOW!"
#define MEK_5_2                 "Initiate Phase I: Recapture the enemy airfield!"
#define MEK_5_3                 "Destroy their rocket launchers and achieve total air superiority!"
#define SOUND_MEK_5             17539 // 13500
#define MEK_6_1                 "Targets in sight! Squads, deploy: Destroy all enemy rocket launchers!"
#define SOUND_MEK_6             17541 // 6730
#define MEK_7_1                 "That's one down. Keep attacking!"
#define SOUND_MEK_7             17542 // 4970
#define MEK_8_1                 "There's another destroyed. Maintain the assault!"
#define SOUND_MEK_8             17543 // 6160
#define MEK_9_1                 "Excellent work. Don't let up!"
#define SOUND_MEK_9             17544 // 4140
#define MEK_10_1                "The airfield is ours, and with it, the skies over Gnomeregan."
#define MEK_10_2                "Now our Multi-Bombers can obliterate the Thermaplugg's shielded Tankbuster Cannons."
#define MEK_10_3                "Initiate Phase II: Capture the Surface Command Post!"
#define SOUND_MEK_10            17546 // 16970
#define MEK_11_1                "Our Multi-Bombers have destroyed Tankbuster Cannons' shields. Take them down and secure the Surface Command Post!"
#define SOUND_MEK_11            17547 // 9740
#define MEK_12_1                "We've secured the surface! Operation: Gnomeregan is proceeding with 93% efficiency...well done, everyone!"
#define MEK_12_2                "I'll shut down the defensive radiation pumps. Squads, commandeer the remaining mechanized suits and move up to the Main Entry."
#define SOUND_MEK_12            17548 // 16660
#define MEK_13_1                "We stand at the brink of victory, my friends. Initiate Phase III: Into the tunnels!"
#define MEK_13_2                "Once we capture the underground railway and loading dock, we'll use them to make a rapid attack on the heart of the city."
#define MEK_13_3                "Gnomeregan is within our grasp!"
#define SOUND_MEK_13            17549 // 17600
#define THERM_1_1               "NEVER! Wait...is this thing on? Is it... this button? Testing...testing. Ah! *ahem*"
#define THERM_1_2               "NEVER! Gnomeregan is MINE, Mekkatorque."
#define THERM_1_3               "You think you'll just march into MY city?"
#define THERM_1_4               "Activate the Expendable Atomic Defense System: DRIVE FORTH THE TROGGS!!!"
#define SOUND_THERM_1           17569 // 23190
#define MEK_14_1                "My GEARS...that's got to be every last trogg in the city! Squads, dig in!"
#define MEK_14_2                "Frag bombs and suppressing fire...HOLD THE LINE! We won't be turned back now!"
#define SOUND_MEK_14            17550 // 14230
#define MEK_15_1                "Sweet baby titans! That's got to be the biggest trogg I've ever seen! Keep firing...take it down!"
#define SOUND_MEK_15            17551 // 9560
#define MEK_16_1                "It's too quiet. Where are Thermaplugg's defense forces?"
#define SOUND_MEK_16            17552 // 5520
#define MEK_17_1                "What...what is that? That looks like the radiation bomb that poisoned Gnomeregan...wait! Incoming!"
#define SOUND_MEK_17            17553 // 9690
#define BOLTCOG_1               "Our defenses are impenetrable! WE are the true sons of Gnomeregan!"
#define SOUND_BOLTCOG_1         17665 // 6100
#define THERM_2_1               "No! No, no, NO!!! I won't allow you into my kingdom, usurper! I WON'T ALLOW IT!"
#define THERM_2_2               "Activate the Ultimate Atomic Protection System."
#define THERM_2_3               "...DISINTEGRATE THEM ALL!"
#define SOUND_THERM_2           17570 // 14640
#define MEK_18_1                "IT'S A TRAP! That's a fully functional irradiator!"
#define SOUND_MEK_18            17554 // 3830
#define THERM_3_1               "It is... and twenty-six TIMES more powerful than the first!"
#define THERM_3_2               "You've FAILED, Mekkatorque! I've caught and defeated you before you even set FOOT in my precious city!"
#define THERM_3_3               "Now DIE!"
#define THERM_3_4               "Oh, I'd love to see that old cog's face. I bet he...what? It's still on? WELL TURN IT O-"
#define SOUND_THERM_3           17571 // 22980
#define IRRADIATOR_1_1          "Irradiator 3000 activated. Attention. Emergency. You now have ten minutes to reach minimum safe distance."
#define SOUND_IRRADIATOR_1      17635 // 10830
#define MEK_19_1                "Ten minutes? Plenty of time to disarm the device."
#define MEK_19_2                "Hinkles, hand me that Whirring Bronze Gizmo and some Fresh Spring Water. Cogspin, toss me that Dirty Trogg Cloth and a Handful of Copper Bolts..."
#define SOUND_MEK_19            17556 // 14930
#define THERM_4_1               "TEN MINUTES?! You left the factory setting on? Give me that controller, you idiot!"
#define SOUND_THERM_4           17572 // 9970
#define IRRADIATOR_2_1          "*BEEP* Attention. Emergency. You now have ten seconds to reach minimum safe distance."
#define SOUND_IRRADIATOR_2      17636 // 7670
#define MEK_20_1                "Whuh-oh! We've gotta get outta here! Lapforge, beam us back, quickly!"
#define SOUND_MEK_20            17557 // 4790
#define MEK_21_1                "Curses! We had to fall back. But Thermaplugg's lost, and he knows it...he's only bought himself time."
#define MEK_21_2                "We hold the surface, and when the radiation clears we'll assault and recapture Gnomeregan with a force twice this size."
