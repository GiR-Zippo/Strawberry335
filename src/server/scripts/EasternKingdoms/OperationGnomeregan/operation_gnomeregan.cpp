                ...
                if (uiStep_timer <= diff)
                {
                    switch (uiStep)
                    {
                        ...
                        case 18:
                            ...
                            me->SummonGameObject(GO_RAD_CONTROL, RadControlSpawn.GetPositionX(), RadControlSpawn.GetPositionY(), RadControlSpawn.GetPositionZ(), RadControlSpawn.GetOrientation(), 0, 0, 0, 0, 0);
                            for (int8 n = 0; n < 3; ++n)
    ...
    public:
        ...
        struct npc_og_bomberlAI : public ScriptedAI
        {
            ...
            void MoveInLineOfSight(Unit* who)
            {
                ...
                me->CastSpell(who, SPELL_ROCKET, true);
