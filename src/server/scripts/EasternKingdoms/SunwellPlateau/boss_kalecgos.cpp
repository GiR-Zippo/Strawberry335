...
public:
    ...
    struct boss_kalecgosAI : public ScriptedAI
    {
        ...
        void DoAction(const int32 param)
        {
            switch (param)
            {
                case DO_ENRAGE:
                    ...
                    break;
                case DO_BANISH: // Boss fix needed (Temp disabled) @todo
                    /*isBanished = true;
        ...
        {/* Boss fix needed (Temp disabled) @todo
        ...
        */}
        ...
        {
            // Boss fix needed (Temp disabled) @todo
            if (Creature* Sath = sObjectAccessor->GetCreature(*me, SathGUID))
                killer->DealDamage(Sath, Sath->GetHealth());
        }
