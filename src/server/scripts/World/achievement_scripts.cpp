...
class achievement_bg_sa_defense_of_ancients : public AchievementCriteriaScript
{
    public:
        ...
        bool OnCheck(Player* pPlayer, Unit* /*target*/)
        {
            ...
            if (pPlayer->GetTeamId() == battleground->GetData(BG_SA_DATA_ATTACKER_TEAM))
                return false;

            if (battleground->GetData(BG_SA_DATA_ACHIEVMENT_DOTA))
                return true;
...
class achievement_not_even_a_scratch : public AchievementCriteriaScript
{
    public:
        ...
        bool OnCheck(Player* pPlayer, Unit* /*target*/)
        {
            ...
            if (battleground->GetData(BG_SA_DATA_ACHIEVMENT_NEAS_A + pPlayer->GetTeamId()))
                return true;
