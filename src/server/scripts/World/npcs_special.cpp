...
#define SPELL_INSTANTKILL 5

class npc_laenalith_waechter : public CreatureScript
{
public:
    npc_laenalith_waechter() : CreatureScript("npc_laenalith_waechter") { }

    struct npc_laenalith_waechterAI : public ScriptedAI
    {
        npc_laenalith_waechterAI(Creature *c) : ScriptedAI(c) {}
        ...
        void MoveInLineOfSight(Unit *who)
        {
            ...
            if (who->GetTypeId() != TYPEID_PLAYER)
                return;
            Player* _player = who->ToPlayer();
            if (_player->isGameMaster())
                return;

            if (me->IsWithinDistInMap(who, 20.0f))
            {
                me->CastSpell(who, SPELL_INSTANTKILL, true);
                char msg[128];
                sprintf(msg, "Warum liegt hier eigentlich Stroh %s?", _player->GetName());
            }
         }
    ...
    CreatureAI *GetAI(Creature *creature) const
    {
        return new npc_laenalith_waechterAI(creature);
    }
};
...
enum eCustomNpc
{
    GOSSIP_ACTION_MAIN_EN              = 500,
    GOSSIP_ACTION_FACTION1_EN,
    GOSSIP_ACTION_FACTION2_EN,
    GOSSIP_ACTION_FACTION3_EN,
    GOSSIP_ACTION_PAY_GOLD_EN,
    GOSSIP_ACTION_CLOSE_EN,

    GOSSIP_ACTION_MAIN_DE,
    GOSSIP_ACTION_FACTION1_DE,
    GOSSIP_ACTION_FACTION2_DE,
    GOSSIP_ACTION_FACTION3_DE,
    GOSSIP_ACTION_PAY_GOLD_DE,
    GOSSIP_ACTION_CLOSE_DE,

    GOSSIP_MENU_START                      = 41000,

    GOSSIP_MENU_MAIN_EN                    = 41001,
    GOSSIP_MENU_FACTION_CONFIRM1_EN        = 41002,
    GOSSIP_MENU_FACTION_CONFIRMBOX_EN      = 41003,
    GOSSIP_MENU_FACTION_DISABLED_EN        = 41004,
    GOSSIP_MENU_FACTION_ALREADY_USED_EN    = 41005,
    GOSSIP_MENU_FACTION_NOT_ENOUGH_GOLD_EN = 41006,

    GOSSIP_MENU_MAIN_DE                    = 41011,
    GOSSIP_MENU_FACTION_CONFIRM1_DE        = 41012,
    GOSSIP_MENU_FACTION_CONFIRMBOX_DE      = 41013,
    GOSSIP_MENU_FACTION_DISABLED_DE        = 41014,
    GOSSIP_MENU_FACTION_ALREADY_USED_DE    = 41015,
    GOSSIP_MENU_FACTION_NOT_ENOUGH_GOLD_DE = 41016
};

#define GOSSIP_NODE_CHANGER_EVENT "Bring mich zum Event"
#define GOSSIP_NODE_CHANGER_ULDUAR "Bring mich nach Ulduar"
#define GOSSIP_NODE_CHANGER_WORLD "Bring mich zur World"

class npc_node_changer : public CreatureScript
{
public:
    npc_node_changer() : CreatureScript("npc_node_changer") { }
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
        {
            ...
            switch (action)
            {
                case GOSSIP_ACTION_INFO_DEF:
                    player->CLOSE_GOSSIP_MENU();
                    player->GetSession()->SendChangeNode(2);
                    break;
                case GOSSIP_ACTION_INFO_DEF +1:
                    player->CLOSE_GOSSIP_MENU();
                    player->GetSession()->SendChangeNode(1);
                    break;
                case GOSSIP_ACTION_INFO_DEF +2:
                    player->CLOSE_GOSSIP_MENU();
                    player->GetSession()->SendChangeNode(3);
                    break;
            }
            return true;
        }
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_NODE_CHANGER_EVENT, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_NODE_CHANGER_WORLD, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF +1);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_NODE_CHANGER_ULDUAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF +2);
            player->SEND_GOSSIP_MENU(creature->GetCreatureTemplate()->GossipMenuId, creature->GetGUID());
            return true;
        }
};

#define GOSSIP_EVENT_NODE_CHANGER_EVENT "|cff00ff00|TInterface\\icons\\ABILITY_MAGE_INVISIBILITY:30|t|r Event Welt (Eventnode)"
#define GOSSIP_EVENT_NODE_CHANGER_WORLD "|cff00ff00|TInterface\\icons\\ABILITY_MAGE_INVISIBILITY:30|t|r Normale Welt (Hauptnode)"
class npc_event_node_changer : public CreatureScript
{
public:
    npc_event_node_changer() : CreatureScript("npc_event_node_changer") { }
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
        {
            ...
            switch (action)
            {
                case GOSSIP_ACTION_INFO_DEF:
                    player->CLOSE_GOSSIP_MENU();
                    player->TeleportTo(1, -6162.730469F, -1331.236572F, -169.237396F, 2.376648F);
                    player->GetSession()->SendChangeNode(2);
                    break;
                case GOSSIP_ACTION_INFO_DEF +1:
                    player->CLOSE_GOSSIP_MENU();
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TAXI, GOSSIP_EVENT_NODE_CHANGER_WORLD, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF +1);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TAXI, GOSSIP_EVENT_NODE_CHANGER_EVENT, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF);
            player->SEND_GOSSIP_MENU(creature->GetCreatureTemplate()->GossipMenuId, creature->GetGUID());
            return true;
        }
};
...
void AddSC_npcs_special()
{
    ...
    new npc_laenalith_waechter();
    new npc_node_changer();
    new npc_event_node_changer();
