#ifndef __MARROWGAR_H
#define __MARROWGAR_H
...
#define BONE_SLICE_HELPER RAID_MODE<uint32>(69055, 70814, 69055, 70814)
#define BONE_SPIKE_GRAVEYARD_HELPER RAID_MODE<uint32>(69057, 70826, 72088, 72089)
