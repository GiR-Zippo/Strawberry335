...
//#define SKIP_UPPER_SPIRE_HC
//#define SKIP_LK_HC
#define SKIP_GUNSHIP
#define GOSSIPICCBUFFENDPAGE 3

uint32 const EncounterCount = 15;
uint32 const WeeklyNPCs = 9;
uint32 const MaxHeroicAttempts = 50;

uint32 const ICCBuffEntries[2][6] =
{
...
Position const GunshipErsatzSummonerPos = {4236.64f, 2484.56f, 211.03f, 3.07f};
...
enum GossipOptions
{
    GOSSIP_OPTION_REMOVE_ICC_BUFF   = 0,
};
...
enum DataTypes
{
    ...
    DATA_SINDRAGOSA_GAUNTLET = 11,
    DATA_SINDRAGOSA = 12,
    DATA_THE_LICH_KING = 13,
    DATA_KRIFFEL = 14,
    DATA_THE_LICH_KING_HC = 15,
    ...
    DATA_KINETIC_BOMB_COUNT,
    DATA_FROSTMOURNE_TELEPORT,

    // Putricide Trap
    DATA_PUTRICIDE_GATE_1,
    DATA_PUTRICIDE_GATE_2,
    DATA_PUTRICIDE_GATE_3,
    DATA_PUTRICIDE_ENTRANCE,

    // Gunship
    DATA_FIRST_SQUAD_STATE,
    DATA_SECOND_SQUAD_STATE,
    DATA_SPIRE_FROSTWYRM_STATE,
    DATA_GB_HIGH_OVERLORD_SAURFANG,
    DATA_GB_MURADIN_BRONZEBEARD,
    DATA_HIGH_OVERLORD_SAURFANG_NOT_VISUAL,
    DATA_GB_BATTLE_MAGE,
    DATA_SKYBREAKER_BOSS,
    DATA_ORGRIMMAR_HAMMER_BOSS,
    DATA_MURADIN_BRONZEBEARD_NOT_VISUAL,
    DATA_MURADIN_BRONZEBEARD,
    DATA_GUNSHIP_BATTLE,
    GUID_PLAYER_LOCATION,
    //Achievements
    DATA_BEEN_WAITING_ACHIEVEMENT,
    DATA_NECK_DEEP_ACHIEVEMENT,

    // Debug
    DATA_SKIP_CHECK_LICHKING,
...
enum CreaturesIds
{
    ...
    NPC_INFILTRATOR_MINCHAR_BQ_10               = 38558,
    ...
    NPC_COLDFLAME_TARGET_STALKER                = 37987,
	...
	// Trash Gunship Battle

	NPC_SKYBREAKER_ASSASSIN						= 37017,
	NPC_SKYBREAKER_DREADBLADE					= 37004,
	NPC_SKYBREAKER_HIEROPHANT					= 37027,
	NPC_SKYBREAKER_LUMINARY						= 37016,
	...
	NPC_KOR_KRON_DEFENDER						= 37032,
	NPC_KOR_KRON_INVOKER						= 37033,
	NPC_KOR_KRON_NECROLYTE						= 37149,
	NPC_KOR_KRON_ORACLE							= 37031,
	NPC_KOR_KRON_PRIMALIST						= 37030,
	NPC_KOR_KRON_REAVER							= 37029,
	NPC_KOR_KRON_SNIPER							= 37146,
	NPC_KOR_KRON_STALKER						= 37028,
	NPC_KOR_KRON_TEMPLAR						= 37034,
	NPC_KOR_KRON_VANQUISHER						= 37035,
    ...
    NPC_FLESH_EATING_INSECTS                    = 37782,
...
enum GameObjectsIds
{
    ...
    //Kriffel
    GO_KRIFFEL_AREA_RESTRICTION             = 300304
};
...
class SpellTriggerSpellFromCaster : public SpellScriptLoader
{
    public:
        SpellTriggerSpellFromCaster(char const* scriptName, uint32 triggerId, TriggerCastFlags triggerFlags = TRIGGERED_FULL_MASK) 
                    : SpellScriptLoader(scriptName), _triggerId(triggerId), _triggerFlags(triggerFlags) { }

        class SpellTriggerSpellFromCasterSpellScript : public SpellScript
        {
            PrepareSpellScript(SpellTriggerSpellFromCasterSpellScript);

        public:
            SpellTriggerSpellFromCasterSpellScript(uint32 triggerId, TriggerCastFlags triggerFlags)
            ...
            void Register()
            {
                AfterHit += SpellHitFn(SpellTriggerSpellFromCasterSpellScript::HandleTrigger);
            }
        ...
        {
            return new SpellTriggerSpellFromCasterSpellScript(_triggerId, _triggerFlags);
        }
