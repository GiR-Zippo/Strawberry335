    ...
    public:
        ...
        struct boss_xt002_AI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                if (Unit* heart = Unit::GetUnit(*me, instance->GetData64(DATA_XT002_HEART)))
                    heart->EnterVehicle(me);
            ...
            void SetPhaseOne()
            {
                ...
                heart->AddUnitState(UNIT_STATE_ONVEHICLE); // Hack
                ...
                if (!_hardMode)
                {
                    ...
                    {
                        events.Reset();
                        if (Unit* _player = SelectTarget(SELECT_TARGET_TOPAGGRO, 0, 0.0f, true))
                            _player->DealDamage(me, me->GetHealth() - _transferHealth);
                        heart->RemoveFromWorld();
                        return;
                    }

                    me->SetHealth(me->GetHealth() - _transferHealth);
                }
            }
...
class spell_xt002_tympanic_tantrum : public SpellScriptLoader
{
    public:
        ...
        class spell_xt002_tympanic_tantrum_SpellScript : public SpellScript
        {
            ...
            {
                uint32 pctDmg = GetSpellInfo()->Effects[effIndex].BasePoints;
                uint32 maxHealth = GetHitUnit()->GetMaxHealth();
                maxHealth = maxHealth * pctDmg / 100;
                SetHitDamage(maxHealth);
            }
            ...
            void Register()
            {
                ...
                OnEffectHitTarget += SpellEffectFn(spell_xt002_tympanic_tantrum_SpellScript::CalculateDamage, EFFECT_0, SPELL_EFFECT_SCHOOL_DAMAGE);
            }
        };
