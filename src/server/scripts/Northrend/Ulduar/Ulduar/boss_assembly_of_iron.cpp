...
#define EMOTE_OVERLOAD "Stormcaller Brundir beginnt Überladen zu wirken!"
#define FLOOR_Z 427.266f
    ...
    public:
        ...
        struct boss_stormcaller_brundirAI : public BossAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                ...
                events.ScheduleEvent(EVENT_MOVE_POSITION, 1000, 1);
                        ...
                        case EVENT_MOVE_POSITION:
                            if (me->IsWithinMeleeRange(me->getVictim()))
                            {
                                ...
                                if (Creature* trigger = me->FindNearestCreature(NPC_WORLD_TRIGGER, 100.0f, true))
                                    if (me->GetDistance(trigger) >= 35.0f)
