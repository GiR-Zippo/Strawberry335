    ...
    public:
        ...
        struct boss_freyaAI : public BossAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                ...
                me->CastCustomSpell(SPELL_ATTUNED_TO_NATURE, SPELLVALUE_AURA_STACK, 150, me, TRIGGERED_FULL_MASK);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_SOLAR_FLARE:
                        {
                            ...
                            me->CastCustomSpell(SPELL_SOLAR_FLARE, SPELLVALUE_MAX_TARGETS, stackAmount, me, TRIGGERED_NONE);
