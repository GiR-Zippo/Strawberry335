...
public:
    ...
    class spell_general_vezax_mark_of_the_faceless_AuraScript : public AuraScript
    {
        ...
        {
            GetCaster()->CastCustomSpell(SPELL_MARK_OF_THE_FACELESS_LEECH, SPELLVALUE_BASE_POINT1, aurEff->GetAmount(), GetTarget(), TRIGGERED_FULL_MASK);
        }
...
class spell_general_vezax_mark_of_the_faceless_drain : public SpellScriptLoader
{
    public:
        ...
        class spell_general_vezax_mark_of_the_faceless_drain_SpellScript : public SpellScript
        {
            ...
            {
                targets.remove((WorldObject*) GetExplTargetUnit());
            }
...
{
    public:
        achievement_i_love_the_smell_of_saronite_in_the_morning() : AchievementCriteriaScript("achievement_smell_saronite") { }
