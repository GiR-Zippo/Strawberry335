...
Log::Log() :
    ...
    performanceLogFile(NULL), m_gmlog_per_account(false), m_enableLogDBLater(false),
...
void Log::Initialize()
{
    ...
    performanceLogFile = openLogFile("Performance.LogFile", "LogTimestamp", "w");
...
void Log::outWarden(const char * str, ...)
{
    ...
    outDebug(LOG_FILTER_WARDEN, str);
