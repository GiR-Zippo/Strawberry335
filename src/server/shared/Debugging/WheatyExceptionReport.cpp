...
PEXCEPTION_POINTERS pExceptionInfo)
{
    ...
    sprintf(m_szDumpFileName, "%s\\%s_%s_[%u-%u_%u-%u-%u].dmp",
        crash_folder_path, git::getHash(), pos, systime.wDay, systime.wMonth, systime.wHour, systime.wMinute, systime.wSecond);
...
PEXCEPTION_POINTERS pExceptionInfo)
{
    ...
    _tprintf(_T("Revision: %s%s%s\r\n"), _FULLVERSION_A, git::getProduktVersionStr(), _FULLVERSION_B);
