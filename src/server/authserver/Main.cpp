...
char serviceDescription[] = "TrinityCore World of Warcraft emulator authentication service";
/*
...
CharacterDatabaseWorkerPool CharacterDatabase;              // Accessor to the auth server database // not needed but implemented for linker
...
extern int main(int argc, char **argv)
{
    ...
    sLog->outString("%s%s%s (authserver)", _FULLVERSION_A, git::getProduktVersionStr(), _FULLVERSION_B);
