...
//# define _TRINITY_CORE_CONFIG "D:/Development/C++Projekte/SingleCore/Sarana/win/bin/RelWithDebInfo/worldserver.conf"
...
LogonDatabaseWorkerPool LogonDatabase;                      ///< Accessor to the node/logon database
