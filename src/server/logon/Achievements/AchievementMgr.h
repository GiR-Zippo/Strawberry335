...
{                                                           // value1         value2        comment
    ...
    ACHIEVEMENT_CRITERIA_DATA_NTH_BIRTHDAY             = 21,// N                            login on day of N-th Birthday
    ACHIEVEMENT_CRITERIA_DATA_KNOWN_TITLE              = 22,// title_id                     known (pvp) title, values from dbc
...
class AchievementMgr
{
    public:
        ...
        void SendRespondInspectAchievements(Player* d_player) const;
        ...
        void SetCriteriaProgress(AchievementCriteriaEntry const* entry, uint32 changeValue, uint8 ptype = PROGRESS_SET);
    private: 
